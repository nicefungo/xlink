...
| 插件化架构 | ✅ v2.0 已发布 | `.so` 动态加载 + `xlink_open_url()` (2026-05-29) |
| 异步 I/O | ✅ v2.0 已发布 | epoll/poll 引擎 + `xlink_wait_aio()` (2026-05-29) |
| 异步 I/O 深化 | 📝 规划中 (v2.1) | SHM eventfd, xlink_run(), io_uring |
